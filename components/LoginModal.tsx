        ...
        <ModalShell onClose={onClose} labelledBy="login-title">
            ...
            <div className="flex flex-col p-5 sm:p-6 md:p-8 max-h-[calc(100vh-4rem)] overflow-y-auto">
                ...
                <div className="mb-6 flex flex-col gap-2 text-center">
                    <h1 id="login-title" className="font-display text-2xl sm:text-3xl font-bold tracking-tight text-[#111418] dark:text-white">
                        Welcome Back
                    </h1>
                    <p className="text-sm font-normal leading-normal text-[#617589] dark:text-gray-400">
                        Sign in to access your Paradise DayPass account.
                    </p>
                </div>
                ...
                <div className="mt-6 flex items-center gap-3">
                    <div aria-hidden="true" className="h-px flex-1 bg-black/10 dark:bg-white/10"></div>
                    <span className="text-sm font-medium text-[#617589] dark:text-gray-400">Or continue with</span>
                    <div aria-hidden="true" className="h-px flex-1 bg-black/10 dark:bg-white/10"></div>
                </div>
