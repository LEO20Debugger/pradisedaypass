        ...
        <footer className="bg-background-light dark:bg-background-dark border-t border-gray-200 dark:border-gray-800 pt-16 pb-8 px-4">
            <div className="max-w-[1280px] mx-auto">
                        ...
                        <div key={index}>
                            ...
                            <ul className="space-y-3 text-sm text-gray-500">
                                {section.links.map((link, linkIndex) => (
                                    <li key={linkIndex}>
                                        <Link className="hover:text-luxury-gold transition-colors" href={link.href}>
                                            {link.name}
                                        </Link>
                                    </li>
                                ))}
                ...
                <div className="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-sm text-gray-400">© {new Date().getFullYear()} Paradise DayPass. All rights reserved.</p>
